...
class cs_phpDB extends cs_webapplibsAbstract {
	 ...
	 * @return unknown_type
	 */
	public function __construct($dsn, $username, $password, array $driverOptions, $writeCommandsToFile=null) {
		
		$this->dbLayerObj = new PDO($dsn, $username, $password, $driverOptions);
		$this->dsn = $dsn;
...
//FINDME
	...
	function exec($query,$setLastQuery=true) {
		...
		$returnVal = false;
		$numRows = $this->dbLayerObj->exec($query);
